...
# I noticed an error on Rentlytics website that through the following error:


# #####.    Uncaught TypeError: jQuery(...).headroom is not a function
#             at HTMLDocument.<anonymous> (rentlytics.com/:943)
#             at i (jquery.js:2)
#             at Object.fireWith [as resolveWith] (jquery.js:2)
#             at Function.ready (jquery.js:2)
#             at HTMLDocument.K (jquery.js:2)
# Without looking at the file structure I can't determine if the folder structures in dist 
# include the headroom.js and jQuery.headroom.js scripts in your page so that this error 
# is fixed to load your customized header functions
